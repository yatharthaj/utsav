(function (namespace, $) {
	...
	p._initDatePicker = function () {
        ...
        $('#start-date').datepicker({autoclose: true, todayHighlight: true, format: "yyyy/mm/dd"});
        $('#start-date-edit').datepicker({autoclose: true, todayHighlight: true, format: "yyyy/mm/dd"});
        $('#valid').datepicker({autoclose: true, todayHighlight: true, format: "yyyy/mm/dd"});
        $('#valid-edit').datepicker({autoclose: true, todayHighlight: true, format: "yyyy/mm/dd"});
        ...
        $('#start-datePrice').datepicker({autoclose: true, todayHighlight: true, format: "yyyy-mm-dd"});
        $('#end-datePrice').datepicker({autoclose: true, todayHighlight: true, format: "yyyy-mm-dd"});
	};
