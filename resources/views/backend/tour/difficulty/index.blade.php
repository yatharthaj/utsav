...
@section('content')
    <div class="row">
                        ...
                        <tr class="item{{$level->id}}">
                            ...
                            <td>
                                <button type="submit" class="btn ink-reaction btn-floating-action btn-sm btn-info " id="edit-modal" style="margin-right: 10px;"
                                        data-id="{{$level->id}}" data-name="{{$level->name}}" data-toggle="modal"
                                        data-target="#formModal">
                                    <i class="fa fa-pencil" aria-hidden="true"></i>
                                </button>
                                <button type="button" class="btn ink-reaction btn-floating-action btn-sm  btn-danger" data-id="{{$level->id}}" data-toggle="modal"
        ...
        <div class="col-lg-4">
            <form class="form" method="POST" action="{{ route('difficulty.store') }}">
                {{ csrf_field() }}
                <div class="card">
                    <div class="card-head style-primary">
                        <header>Create new level</header>
                    </div>
