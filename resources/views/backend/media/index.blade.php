...
@section('content')
    <div class="row">
        ...
        <div class="col-sm-4">
            <p><a href="{{ route('media.create') }}" class="btn btn-block ink-reaction btn-primary">Add Images</a></p>
        </div>
    </div>
    <div class="row">
            ...
            <div class="col-md-4 col-sm-6">
                <div class="thumbnail">
                    ...
                    <div class="card-actionbar">
                        <a href="{{ route('carousel.edit',$media->id) }}" class="btn  ink-reaction btn-info" data-toggle="tooltip" title="Edit">
                            <i class="md-mode-edit"></i>
                        </a>
                        {!!  Form::open( array('route'=>array('carousel.destroy', $media->id),'method'=>'DELETE')) !!}
        ...
        @foreach($medias as $media)
            <div class="col-sm-6 col-md-6 item{{$media->id}}">
                <div class="thumbnail">
                    <img src="{{asset($media->path)}}" alt="" class="img-responsive">
                    <div class="caption">
                        @if(!empty($media->name))
                            <h4>{{$media->name}}</h4>
                        @else
