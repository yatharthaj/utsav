...
@section('content') @if(!empty($slides))
<div class="owl-carousel owl-theme home-slider">
    @foreach($slides as $slide)
    <img class="item responsive-img" src="{{ asset($slide->path) }}" alt=""> @endforeach
</div>
@endif

<!-- heading start -->
<div class="container-fluid heading-wrapper">
    <h3 class="center-align heading-title">YOUR VENTURE LEADS TO ADVENTURE</h3>
...
<div class="container-fluid">
    <div class="row symbol">
        <div class="col s12 m4 l4 center-align feature-wrapper">
            ...
            <h5 class="center-align">Sustainable</h5>
            <p class="center-align">
                We always support sustainable development to protect our nature by using degradable product, planting trees and local product.
                We believe in working directly with local guide and people and protect the beauty of Nepal for hundreds of
                years.
            </p>
        ...
        <div class="col s12 m4 l4 center-align feature-wrapper">
            ...
            <h5 class="center-align">Safety and Quality</h5>
            <p class="center-align">
                We think safety and quality is the key for successful journey. We always try to keep our guest in good condition in every
                means physically and mentally by providing our best hospitality in mountains with the help of our best guide
                and cook. Safety first is our main motto.
            </p>

        </div>
        <div class="col s12 m4 l4 center-align feature-wrapper">
            <div class="featured-ski"></div>
            <h5 class="center-align">Social Impact</h5>
            <p class="center-align">
                We are main sponsor to Charity organization Ski and Snowboarding Foundation Nepal which promote winter sport in Nepal. We
                provide 30% of our profit to this organization in order to develop Ski/snowboard culture among Nepalese.
            </p>
        </div>
...
<div class="container-fluid trip-wrapper">
    ...
    @include('frontend.partials._tripadvisor')
        ...
        <div class="col s12 m6 l6 intro Uk-margin-remove">
            ...
            <p>We seek to promote the skiing culture in Nepal in days to come. apart from mainstream treks, Skiing Is complete
                new recreation activity in Nepal however, we have witnessed professional skiers who successfully accomplished
                skiing activity in the Himalayas. Nepal and its Himalayas have good potential to attract passionate travelers,
                who wish to hit slopes of Nepal once in a lifetime. Realizing The possibility of new adventure sports to
                the Native land of Himalayas, Ski Guides Nepal Is Formed.</p>
...
<div class="parallax-container center valign-wrapper" id="offer">
    <div class="parallax"><img src="{{asset('img/banner/annapurna.jpg')}}">
    </div>
        ...
        <div class="col s12 m4 l4">
            <div class="card">
                ...
                <div class="card-content package-meta">
                    <a href="{{ route('frontend-tourDetail',[$tour->slug]) }}" class="card-title uk-margin-remove-vertical" id="package-title">{{$tour->title}}</a>
                    <div class="unit">
...
{{-- trip of the month start --}} @if(!empty($month))
    ...
    <div class="container-fluid tofm-wrap ">
        ...
        <div class="row">
            <div class="col s12 m6 l6 uk-padding-removel" id="tofm-img-wrapper">
                <img class="responsive-img" src="{{asset($month->tour->featuredImage->path)}}" alt="{{$month->tour->title}}">
            </div>
                ...
                <div class="show-on-medium-and-down">
                    <div class="tofm-meta-wrapper  uk-margin-remove-vertical">
                        ...
                        <div class="center-align heading-button uk-padding-large">
                            <a class="waves-effect waves-light btn btn-large tofm-meta-wrapper-buttom" href="{{ route('frontend-tourDetail',[$month->tour->slug]) }}">Discover</a>
                        </div>
...
@endif {{-- trip of the month end --}} {{-- youtube,instagram start--}}
    ...
    <div class="row social-row">
        ...
        <div class="col s12 m6 l6 heading-wrapper " id="youtube-wrapper">
            ...
            <div class="video-container">
                <iframe width="853" height="640" src="https://www.youtube.com/embed/7ZXWtxc5Xxk" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
